...
OUTPUTDIR = ../bin
CC = g++
CC_FLAGS = -w -std=c++11 -DBASEDIR=\"$(BASEDIR)/RayTracer\" -I$(BASEDIR)/zmq_widgets/Widget/src -I$(BASEDIR)/RayTracer/libRayTracer2014/src -I/usr/local/include/freetype2
