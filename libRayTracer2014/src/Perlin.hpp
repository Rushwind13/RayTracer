...
// This class is a C++ (using std-c++11) translation of
// the Reference Java Implementation of Improved (2002) Perlin Noise
// The original Java implementation is released as "COPYRIGHT 2002 KEN PERLIN"
